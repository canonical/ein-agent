...
For detailed configuration of UTCP services, authentication, multi-instance support, OpenAPI spec loading, and tool call approval policies, see [How to configure the Ein Agent worker](./how-to-configure-ein-agent-worker.md).
